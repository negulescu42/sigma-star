...
\parbox{0.92\textwidth}{\centering\normalfont\small $^{1}$The Informational Buildup Foundation (IBF), Bucharest, Romania.\quad $^{2}$Bucharest, Romania.\quad $^{3}$Simion Stoilow Institute of Mathematics of the Romanian Academy (IMAR), Bucharest, Romania.\\[0.2em] Corresponding author: R. Negulescu (\texttt{radu@ibf.ro}). C. Bereanu: \texttt{c.bereanu@imar.ro}; M. T\u{a}nase: \texttt{mihai@gmail.com}.}}
\date{}
